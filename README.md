...
## Overview
This demo application shows an implementation of a motion sensor. The app is based on the Mesh Snip mesh\_sensor\_server sample which implements the generic BLE Mesh Sensor Server model.
